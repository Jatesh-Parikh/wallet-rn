    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity
          ...
          onPress={() => router.back()}
        >
          <Ionicons name="arrow-back" size={24} color={coffeeTheme.text} />
        </TouchableOpacity>
        ...
        >
          ...
          {!isLoading && (
            <Ionicons name="checkmark" size={18} color={coffeeTheme.primary} />
          )}
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.card}>
        <View style={styles.typeSelector}>
          ...
          >
            <Ionicons
              ...
              size={22}
              color={isExpense ? coffeeTheme.white : coffeeTheme.expense}
          ...
          >
            <Ionicons
              ...
              size={22}
              color={!isExpense ? coffeeTheme.white : coffeeTheme.income}
              style={styles.typeIcon}
            />
            <Text
              style={[
        ...
        <View style={styles.amountContainer}>
          ...
          <TextInput
            ...
            placeholder="0.00"
            placeholderTextColor={coffeeTheme.textLight}
            value={amount}
